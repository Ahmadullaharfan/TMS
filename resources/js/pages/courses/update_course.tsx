...
export default function UpdateCourse() {
    const { course, teachers } = usePage<CourseProps>().props;

    const breadcrumbs: BreadcrumbItem[] = [
        {
            title: 'دلته تاسي کولاي شي د کورس اړوند معلومات تغیر کړي',
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="د کورس معلومات تغیرول" />
            <div className="flex h-full flex-1 flex-col items-center gap-4 overflow-x-auto rounded-xl p-4">
                <div className="page-container">
                    <h1 className="form-title">د کورس معلومات تغیرول</h1>
                    <p className="form-subtitle">دلته تاسي کولاي شي د کورس اړوند معلومات تغیر کړي</p>
